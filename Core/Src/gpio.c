...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : PWRCTRL_Pin */
  GPIO_InitStruct.Pin = PWRCTRL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(PWRCTRL_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : IN_Check_Pin OUT_Check_Pin */
  GPIO_InitStruct.Pin = IN_Check_Pin|OUT_Check_Pin;
