...
void MX_FDCAN1_Init(void)
{
  ...
  sFilterConfig.FilterIndex = 0;                    // 使用第0个扩展滤波器
  sFilterConfig.FilterType = FDCAN_FILTER_MASK;      // 掩码模式
  sFilterConfig.FilterConfig = FDCAN_FILTER_TO_RXFIFO0; // 匹配的数据放入 RX FIFO 0
  sFilterConfig.FilterID1 = 0x00000000;              // 期望的扩展ID（29位） = 0
  sFilterConfig.FilterID2 = 0x1FFFFFFF;              // 掩码：29位全为1，要求ID完全匹配
